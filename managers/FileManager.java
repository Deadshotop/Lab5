...
public class FileManager extends IOManager {
    ...
    public FileManager(HashTableManager products, String path, boolean script, NavigableSet<File> callHistory) throws FileNotFoundException, RecursiveScript, NullPointerException {
        super(products);
    ...
    public void readData() {
        if (script) {
            while (lineNum < dataFile.length - 1) {
                exit = Execute.doCommand(dataFile[lineNum++], products, this);
                if (exit) {
                    break;
                }
            }
    ...
    public Person getOwner() {
        ...
        try {
            ...
            System.out.println("Incorrect data in script on line: " + lineNum);
        }
        return owner;
    }
    ...
    public Product getProductFromCsv(String data, int line) {
        ...
        try {
            ...
            System.out.println("Incorrect data in file on line: " + line);
            return null;
        }
        //return null;
    }
