...
public class Person {
    ...
    private product.eyes.Color eyeColor; //Поле не может быть null
    private product.hair.Color hairColor; //Поле может быть null
    ...
    public Person(String name, ZonedDateTime birthday, Color eyeColor, product.hair.Color hairColor, Country nationality, Location location) {
        this.name = name;
